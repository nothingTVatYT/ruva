package net.nothingtv.ruva.lwjgl3;

import com.badlogic.gdx.backends.lwjgl3.Lwjgl3Application;
import com.badlogic.gdx.backends.lwjgl3.Lwjgl3ApplicationConfiguration;
import net.nothingtv.ruva.client.GeneralSettings;
import net.nothingtv.ruva.client.MainGame;
...
public class Lwjgl3Launcher {
    ...
    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        ...
        configuration.setWindowedMode(GeneralSettings.current.windowWidth, GeneralSettings.current.windowHeight);
