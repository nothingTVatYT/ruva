package net.nothingtv.ruva.client.shaders;
...
import net.nothingtv.ruva.client.terrain.TerrainFloatAttribute;
import net.nothingtv.ruva.client.terrain.TerrainTextureAttribute;
